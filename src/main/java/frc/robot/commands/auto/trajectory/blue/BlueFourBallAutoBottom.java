...
public class BlueFourBallAutoBottom extends SequentialCommandGroup {

    public BlueFourBallAutoBottom(Drivetrain drivetrain, IntakeArm intakeArm, Conveyor conveyor, Intake intake, Shooter shooter) {
        addCommands(
            // Intake Arm Down
            ...
            new ParallelDeadlineGroup(
                ...
                new SequentialCommandGroup(
                    new BlueHubToStation(drivetrain),
                    new BlueHubToStationReverse(drivetrain)
                ),
                // intake
            ...
            new ParallelDeadlineGroup(
                ...
                new SequentialCommandGroup(
                    new BlueHubToStation(drivetrain),
                    new BlueStationToStation(drivetrain), 
                    new BlueStationToStationReverse(drivetrain),
                    new BlueHubToStationReverse(drivetrain)
                ),
                // intake
                new IntakeEjectCommand(intake).withTimeout(10.0)
