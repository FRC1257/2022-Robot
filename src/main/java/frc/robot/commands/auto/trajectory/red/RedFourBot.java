    ...
    public Blue2BotCorner(Drivetrain drivetrain, IntakeArm intakeArm, Conveyor conveyor, Intake intake, Shooter shooter) {
        addCommands(
            ...
            new ParallelDeadlineGroup(
                // Drive
                new SequentialCommandGroup(new RedCornerToStation(drivetrain), new RedStationToHub(drivetrain), new RedHubToStation(drivetrain), new RedStationToHub4(drivetrain)),
                // intake
