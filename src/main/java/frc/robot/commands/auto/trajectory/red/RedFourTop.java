...
public class RedFourTop extends SequentialCommandGroup {
    ...
    public RedFourTop(TrajectoryLoader loadedTrajectories, IntakeArm intakeArm, Conveyor conveyor, Intake intake, Shooter shooter) {
        addCommands(
            ...
            new ParallelDeadlineGroup(
                new SequentialCommandGroup(
                    loadedTrajectories.getCommand("2RedHubToStationTop"),
                    loadedTrajectories.getCommand("RedStationToStation"),
                    loadedTrajectories.getCommand("2RedStationtoHubTop")
                ),
                new IntakeIntakeCommand(intake).withTimeout(10.0)
            ),
